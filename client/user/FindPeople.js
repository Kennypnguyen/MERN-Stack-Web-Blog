...
// This component will fetch the users not being followed by the current user. A who to follow feature
...
export default function FindPeople() {
  ...
  // Make the follow API and update the list of users to follow 
