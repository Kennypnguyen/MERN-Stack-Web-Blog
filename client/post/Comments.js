...
// Component that allows the signed in user to type in the comment text
...
export default function Comments (props) {
    ...
    // Will call the comment fetch method if the enter key is pressed 
    ...
    const commentBody = item => {
      ...
      // when comment delte button is clicked, the component will call the deleteComment metohd to fetch uncomment API and update it
